...
from eyetracking.statannotations.format_annotations import pval_annotation_text, \
    simple_text
from eyetracking.statannotations.utils import DEFAULT, check_valid_text_format, \
