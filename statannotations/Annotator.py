...
from eyetracking.statannotations.Annotation import Annotation
from eyetracking.statannotations.PValueFormat import PValueFormat, \
    CONFIGURABLE_PARAMETERS as PVALUE_CONFIGURABLE_PARAMETERS
from eyetracking.statannotations._Plotter import _Plotter, _SeabornPlotter
from eyetracking.statannotations.stats.ComparisonsCorrection import \
    get_validated_comparisons_correction
from eyetracking.statannotations.stats.StatResult import StatResult
from eyetracking.statannotations.stats.StatTest import StatTest
from eyetracking.statannotations.stats.test import apply_test, IMPLEMENTED_TESTS
from eyetracking.statannotations.stats.utils import check_alpha, check_pvalues, \
    check_num_comparisons, get_num_comparisons
from eyetracking.statannotations.utils import check_is_in, InvalidParametersError, \
    empty_dict_if_none
